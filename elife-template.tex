...
\begin{figure}[H]
	\todo[inline]{Jaguar ASR: need to find out why matplotlib title not showing up, tight layout, add confidence intervals instead of +-, smaller font (between 6-9pt)}
\centering
