...
\begin{itemize}
	...
	\item Lessons learned for participating in the challenge
	      \begin{itemize}
	      	\item How should we predict macroscopic pKa values from microscopic pKa values? Explain possibilities and justify choice
	      	      \begin{itemize}
...
Summary of how Jaguar computes pKa values 
...
Several reasonable choices are possible for translating these microscopic properties into macroscopic pKa values.


\subsubsection{Epik scan: Sequential titration of dominant species} 
pass


\subsubsection{Population curves from pKa}
...
\subsubsection{Problematic Lewis structures}
