...
\todo[inline]{track down artifacts that seem to be present in free energy values}
\begin{itemize}
...
\section{Methods}
\subsection{Epik}
Summary of how Epik works \todo[inline]{Fill in snippet from john shelley}
