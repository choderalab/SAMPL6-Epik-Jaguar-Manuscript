...
\begin{figure}[H]
	...
	\todo[inline]{ASR: Add number of area to plot, set axis font sizes to size 9}
\end{figure}
\todo[inline]{add legend for titration curve. Remove charge label for experiment, mae egend thicker and remove charge labels. Add picture of compound}
...
\begin{figure}[H]
	\centering
	\todo[inline, color=red!30]{ASR: Find a good place to put the legen, find source of free energy/ state penalty discrepancy artifacts}
