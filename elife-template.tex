...
\begin{figure}[H]
	...
	\todo[inline]{ASR: Add vector graphics, mention experiment is uvmetric, color legend below. Dont reuse green. align experiment to prediction instead. Add number of area to plot}
\end{figure}
...
\begin{figure}[H]
	\todo[inline]{Show diagonals and +/-1-pK unit diagonals? 3 panels, one for each, with summary statistic in the corner}
\centering
...
\begin{figure}[H]
	...
	\caption{{\bf Epik sequential pKa values compared to experiment, by sequential alignment of pKa values.}
		\todo[inline]{Show diagonals and +/-1-pK unit diagonals?}
