...
\begin{figure}[H]
	\todo[inline]{Jaguar ASR: need to find out why matplotlib title not showing up}
\centering
...
\begin{figure}[H]
	\todo[inline]{Epik type I ASR: need to find out why matplotlib title not showing up}
\centering
...
\begin{figure}[H]
	\todo[inline]{Epik type III ASR: need to find out why matplotlib title not showing up}
\centering
...
\begin{figure}[H]
	\todo[inline]{Epik type III , sequential pKa mapping ASR: need to find out why matplotlib title not showing up}
	\centering
...
\begin{figure}[H]
	\centering
	\todo[inline]{ASR: Find a good place to put the legend, and regenerate figures with lines less thick, or more alpha, add molecules to these}
